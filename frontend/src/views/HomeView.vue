  ...
  <main class="content">
    <form action="#" method="post">
      <div class="content__wrapper">
        ...
        <DoughList class="content__dough" />

        <DiameterList class="content__diameter" />

        <IngredientsList class="content__ingredients" />
...
import DiameterList from '@/components/DiameterList.vue';
